<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-blackten duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0"
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        ...
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="calendar.html" @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                            :class="{
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('verifikasi-pengacara.index') }}"
                            @click="selected = (selected === 'Pengacara' ? '':'Pengacara')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Pengacara') && (page === 'pengacara') }"
                            :class="page === 'pengacara' && 'bg-graydark'">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            Verifikasi Pengacara
                        </a>
                    </li>
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('admin.pengacara.show') }}"
                            @click="selected = (selected === 'Pengacara' ? '':'Pengacara')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Pengacara') && (page === 'pengacara-list') }"
                            :class="page === 'pengacara-list' && 'bg-graydark'">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M9.0002 7.79065C11.0814 7.79065 12.7689 6.1594 12.7689 4.1344C12.7689 2.1094 11.0814 0.478149 9.0002 0.478149C6.91895 0.478149 5.23145 2.1094 5.23145 4.1344C5.23145 6.1594 6.91895 7.79065 9.0002 7.79065ZM9.0002 1.7719C10.3783 1.7719 11.5033 2.84065 11.5033 4.16252C11.5033 5.4844 10.3783 6.55315 9.0002 6.55315C7.62207 6.55315 6.49707 5.4844 6.49707 4.16252C6.49707 2.84065 7.62207 1.7719 9.0002 1.7719Z"
        ...
        {{-- <div
            ...
            <h3 class="mb-1 font-semibold text-white">CerdasHukum</h3>
            <p class="mb-4 text-xs text-white">Pertolongan Pertama Hukum Perdata</p>
            <a href="https://cerdashukum.com" target="_blank" rel="nofollow"
